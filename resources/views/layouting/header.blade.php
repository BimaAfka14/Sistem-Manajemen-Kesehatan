...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4" >
      <!-- Brand Logo -->
      <a href="{{ auth()->user()->role == 'pasien' ? route('dashboardPasien') : route('dashboardDokter') }}" class="brand-link">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            <img src="{{ asset('lte/dist/img/meguri.jpg') }}" class="img-circle elevation-2" alt="User Image">
          </div>
          <div class="info">
